...
public class Tags {
    ...
    public static final String DEMO_QA_TESTS = "demo-qa-tests";
    public static final String GITHUB_TESTS = "github-tests";
    public static final String HEROKU_APP_TESTS = "heroku-app-tests";
